    ...
    <section class="container content-section">
            ...
            <div class="shop-items">
                <div class="shop-item">
                    ...
                    <a href="#"><img class="shop-item-image" src="Images/Silver_beech.jpg"></a>

                    <form action="description.php" method="post">

                        <p>Description: </br></br>

							Tall Attractive tree with silver bark.</br></br>
	Soil Drainage: Well Drained</br></br>
	Sun: Shade </br></br>
	Maintenance requirements: Med</br></br>
	Max height of mature tree: 25m</br></br>
	Growth rate: Med
						<br />
