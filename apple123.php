...
<body>
    ...
    <h2 class="heading">Initial apple Tree</h2>





    <img src="Images/Initial_apple.png" alt="Apple" width="250" height="200" />
    </br>
    </br>
    ...
    <p> Sun: Sunny </p>
    <p> Maintenance requirements: High </p>
    <p> Max height of mature tree: 5m </p>
    <p> Growth rate: slow </p>
    <p> Price for tree: $50 </p>
