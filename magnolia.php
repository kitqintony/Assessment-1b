 	...
 	<section class="container content-section">
             ...
             <div class="shop-items">
                 <div class="shop-item">
                     ...
                     <a href="#"><img class="shop-item-image" src="Images/Little_Gem_Magnolia.png"></a>

                     <form action="description.php" method="post">

                         <p>Description: </br></br>

                            Small – Medium sized evergreen. Lushy Green leaves, Very white flowers, Brown tan underneath.
                        </br>
                    </p>
                    <p> Soil Drainage: Well Drained</p>
                    <p> Sun: Sunny or shade</p>
                    <p> Maintenance requirements: Low </p>
                    <p> Max height of mature tree: 5m </p>
