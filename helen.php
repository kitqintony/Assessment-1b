 	...
 	<section class="container content-section">
             ...
             <div class="shop-items">
                 <div class="shop-item">
                     ...
                     <a href="#"><img class="shop-item-image" src="Images/Paradise_Helen.png"></a>

                     <form action="description.php" method="post">

                         <p>Description: </br></br>

                           Elegant free-flowering variety producing masses of brilliant pink buds.
        </br>
    </p>
    <p> Soil Drainage: Well Drained</p>
    <p> Sun: Med or shade </p>
    <p> Maintenance requirements: Low </p>
    <p> Max height of mature tree: 3m </p>
